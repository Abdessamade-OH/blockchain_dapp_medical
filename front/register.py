...
def show_login_from_register(register_frame, login_page_callback):
    # Call the function to show the login page using the callback
    login_page_callback()
...
def show_register_page(register_frame, login_page_callback):
    ...
    back_button = customtkinter.CTkButton(register_frame, text="Back to Login", corner_radius=0, command=lambda: show_login_from_register(register_frame, login_page_callback))
